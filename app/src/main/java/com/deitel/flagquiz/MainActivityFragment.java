...
public class MainActivityFragment extends Fragment implements CompoundButton.OnCheckedChangeListener
{
   ...
   public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      ///////////////////////////////////////////////////////
      t = (ToggleButton) view.findViewById(R.id.toggleButton);
   ...
   private void animate(boolean animateOut) {
      ...
      int centerX = (quizLinearLayout.getLeft() +
         quizLinearLayout.getRight()) / 15; // calculate center x
      int centerY = (quizLinearLayout.getTop() +
         quizLinearLayout.getBottom()) / 15; // calculate center y
      ...
      if (animateOut) {
         ...
         animator = ViewAnimationUtils.createCircularReveal(
            quizLinearLayout, centerX, centerY, radius, 25);
      ...
      animator.setDuration(200); // set animation duration to 500 ms
   ...
   {
      MediaPlayer mp = MediaPlayer.create(getActivity(), R.raw.incorrect_sound);

      if (isOn)
      {

         quizLinearLayout.setBackgroundColor(Color.WHITE);
         questionNumberTextView.setTextColor(Color.GRAY);

      }
      else
      {

         quizLinearLayout.setBackgroundColor(Color.BLACK);

         questionNumberTextView.setTextColor(Color.WHITE);
      }
